...
%macro Make_all_tables( indata=, list=, col=, colfmt=, title= );
  ...
  %Make_one_table( 
    ...
    vlabel=
      ...
      uQ1_5 = "Other Northern Virigina (outside Fairfax Co)"
      uQ1_6 = "Maryland (no specific place inside region)"
      uQ1_7 = "Viriginia (no specific place inside region)"
  ...
  %Make_one_table( 
    ...
    vlabel=
      rQ1_same = "Same jurisidiction where person lives"
      ...
      rQ1_va = "Viriginia (no specific place inside region)"
  ...
  %Make_one_table( 
    ...
    vlabel=
      ...
      uQ2_5 = "Other Northern Virigina (outside Fairfax Co)"
      uQ2_6 = "Maryland (no specific place inside region)"
      uQ2_7 = "Viriginia (no specific place inside region)"
  ...
  %Make_one_table( 
    ...
    text2="Relative to where respondent actually lives",
    vlabel=
      rQ2_same = "Same jurisidiction where person lives"
      ...
      rQ2_va = "Viriginia (no specific place inside region)"
