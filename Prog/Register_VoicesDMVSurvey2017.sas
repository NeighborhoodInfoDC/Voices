/**************************************************************************
 Program:  Register_VoicesDMVSurvey2017.sas
 Library:  Voices
 ...
 Description:  Register Voices 2017 survey source file
 (Voices.VoicesDMVSurvey2017) with metadata system.
...
proc datasets library=Voices memtype=(data) nolist;
  modify VoicesDMVSurvey2017 (label="VoicesDMV 2017 survey, GfK final source file");
...
%Dc_update_meta_file(
  ds_lib=Voices,
  ds_name=VoicesDMVSurvey2017,
  creator_process=Source file from GfK,
