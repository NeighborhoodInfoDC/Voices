/**************************************************************************
 ...
 Description:  Export Voices survey open-ended questions.
...
%File_info( data=VoicesDMVSurvey2017, printobs=0, freqvars=offpanel )
...
proc sort data=VoicesDMVSurvey2017;
  by dov_urban q1;
run;

ods tagsets.excelxp file="&_dcdata_default_path\Voices\Prog\Voices2017_open_ended_q1.xls" options(embedded_titles='yes');
ods listing close;

title2 'VoicesDMV 2017 Survey';
title3 'NOT FOR CITATION OR RELEASE';

proc print data=VoicesDMVSurvey2017 noobs label;
  by dov_urban;
  var q1 caseid;
run;
...
ods tagsets.excelxp file="&_dcdata_default_path\Voices\Prog\Voices2017_open_ended_q2.xls" options(embedded_titles='yes');
ods listing close;
