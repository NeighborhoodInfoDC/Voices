...
label Q13_count "count of civic engagement"
...
label Q14_count "count of civic activities"
...
label phy_health "Count of days when physical health not good"
...
label ment_health "Count of days when mental health not good"
...
gen anxious = "Very low (0-1)" if Q39C==0 | Q39C==1
replace anxious = "Medium (5-6)" if Q39C==2 | Q39C==3
replace anxious = "High (7-8)" if Q39C==4 | Q39C==5
replace anxious = "Very high (9-10)" if Q39C>=6 & Q39C<=10
