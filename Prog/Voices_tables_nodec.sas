/**************************************************************************
 Program:  Voices_tables_nodec.sas
 Library:  Voices
 ...
 11/2/17  LH Modified Voices_tables.sas (as of 11/1) to have % round to integer. 
		  Only changed fmt and output name.
**************************************************************************/
...
%macro Make_one_table( fmt=percent10., col=, colfmt=, total=y, var=, text=, text2=, vlabel=, data=Voices.Voices_2017_nonopen_recode, typefmt=$coltype_pct. );
...
%macro Make_all_tables( indata=, list=, col=, colfmt=, title= );
  ...
  ods rtf file="&_dcdata_default_path\Voices\Prog\Voices_tables_&col._nodec.rtf" style=Styles.Voices_style_rtf
      bodytitle toc_data;
