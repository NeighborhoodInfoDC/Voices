...
data Voices_Q16_newrecode;
	...
	traffic=traffic+index(Q16_text,"Congestion In Trying To"); 
		if Q16_text in("Commute Times" "Commuting" "Gridlock" "Growing Gridlock, Traffic-wise" "Heavy Beltway Traffic" "Highways" "Traffic Is A Nightmare" "Transport Congestion") then traffic=1; 

	transpo=index(Q16_text,"Public Transit");
	if Q16_text in("Bad Public Transportation" "Cost Of Public Transportation" "Dismal Public Transportation" "Mass Transit" "Transit" "Cabs") then transpo=1;
	...
	if Q16_text in("Dc Metro Service" "Metro Service" "Unreliable Metro Service" "Dc Metro Hours" "Metro System" "Poor Metro System" "Poorly Maintained Subway") then metro=1;
	...
	if Q16_Text in("Extremely Performance Driven" "People Too Focused On Work" "People Work Too Much" "The Competitve/Money-Grubbing Nature" "Transitory Nature"
					...
					"Social Culture" "Culture" "City Is Being Whitewashed, Losing Its Black Culture") then life=1;
	...
	if Q16_text in("High Price for Food/Utilities/Gas" "Restaurant Too Expensive" "Expensive Entertainment" "Declining Standard Of Living" "High Cost Of Service" "Costly"
					"Everything Is Expensive" "Everything Is Ridiculously Expensive" "Expensive" "Expensive Area" "Expensive!" "It's Very Expensive" "Its Expensive" "Little Bit Expensive"
					"Too Expensive" "Very Expensive") then costs=1;
	...
	if Q16_text in("Current White House Occupants" "That Orange Cheeto In The White House" "The Guy In The White House"
					...
					"The Current President And Political Status") then trump=1;
	...
	*new code-  too many people;
	...
	if Q16_text in("Congestion And Crowd" "Congestion Of People" "Congestion/Crowds" "Crowdiness" "Crowdness" "Lots Of People"
				...
				"To Crowded" "Too Crowded") then many=1;
	...
	*new code - not friendly/rude; 
	...
	if Q16_text in("People Stare" "Less Friendlyness" "People Are Not Friendly" "Ill-Tempered People" "People Not To Friendly"
					"Some Of The People Are Not As Friendly" "The People Could Be Nicer." "Unfriendly And Aggressive People" "Not Friendly" "Unfriendly" "Unfriendly To Stangers") then rude=1;
	...
	*new code - fast pace life;
	...
	if Q16_text in("Poor People" "Too Many People Living Under The Government Funds" "Class Divisions" "Poor" "Poor Areas" "The Vast Economic Differences In Various Parts Of The Area"
	...
	if Q16_text in("Political Climate" "Political Atmosphere" "Political Noise" "Everybody Is Political" "It's A Slimy, Political City" "It's Very Conservative" "Politically Focused"
					"Too Political" "Too Political At Times" "Political Culture") then politics=1;

	if housing > 0 then Q16_recode='HOUSING';
	if traffic > 0 then Q16_recode='TRAFFIC';
	if transpo > 0 then Q16_recode='TRANSPORTATION';
	...
	if fast > 0 then Q16_recode='FAST';
	if safety > 0 then Q16_recode='SAFETY';
	if politics > 0 then Q16_recode='POLITICS';
	...
	if Q16_text in("People Stressing" "The Closer To The City The More Stressed The People" "Stressful Lifestyle" "Stressful") then Q16_recode='STRESS';
	...
	if Q16_text in("Car/Vehicle Tax" "High Taxes (Property And Income)" "Taxes In Dc Proper") then Q16_recode="TAXES";
	...
	if Q16_text in("Tourism From D.C.") then Q16_recode="TOURISTS";
	...
	if Q16_text in("Garbage Truck Comes During The Night" "To Loud" "Too Loud") then Q16_recode="NOISE";

	if Q16_text in("Low Emergency Response Time") then Q16_recode="SERVICES";

	if Q16_text in("Not A Lot Of Asians" "Too Many/Different Cultures") then Q16_recode="DIVERSITY";

	if Q16_text in("Not Close For Outdoor Stuff") then Q16_recode="NATURE";
...
proc format;
  ...
  value $Q16_r_det
    ...
    /*'TRUMP' = "Donald Trump"*/
    'PARKING' = "Parking"
    'ENTERTAINMENT','MUSEUMS','MONUMENTS','ARTS','PERFORM','SPORTS'  = "Arts and entertainment"
    'FOOD' = "Food"
    'CULTURE' = "Culture"
    /*'MUSEUMS' = "Museums"
    'MONUMENTS' = "Monuments"
