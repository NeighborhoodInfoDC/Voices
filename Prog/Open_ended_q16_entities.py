...
# inFile = 'L:\Libraries\Voices\Raw\Q16.csv'
# outFile = 'L:\Libraries\Voices\Raw\Q16_recode.csv'

inFile = 'C:\DCData\Libraries\Voices\Raw\Q16.csv'
outFile = 'C:\DCData\Libraries\Voices\Raw\Q16_entities.csv'
...
with open(outFile, 'w', newline='') as csvfile:
    ...
    for d in Mydat:
        ...
        for entity in response.entities:
            ...
            row = { 'caseid': d.caseid, 'respnum': respnum, 'entity': str.upper(entity.name) }
